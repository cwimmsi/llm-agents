...
EXPECTED_CLASSIFICATIONS: Dict[int, TicketClassification] = {
    1: TicketClassification(
        ...
        responsible_team=ResponsibleTeam.INFRASTRUCTURE_TEAM,
    ...
    2: TicketClassification(
        ...
        responsible_team=ResponsibleTeam.APPLICATION_TEAM,
        confidence_score=1.0,
    ),
    ...
    4: TicketClassification(
        ...
        ticket_tags=[TicketTags.ONBOARDING, TicketTags.HARDWARE, TicketTags.SOFTWARE],
    ...
    5: TicketClassification(
        ...
        ticket_priority=TicketPriority.MEDIUM,
        ticket_sentiment=TicketSentiment.NEUTRAL,
        ticket_tags=[TicketTags.SOFTWARE, TicketTags.SECURITY],
